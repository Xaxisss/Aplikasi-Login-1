...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /* Comment : Memastikan bahwa nilai email dan password sesuai dengan nilai tersimpan*/
  if (email == expectedEmail && password == expectedPassword) {
    /* Comment: Jika sesuai maka program akan berpindah ke halaman home*/
    goToHome();
  } else {
    /* Comment: Namun jika tidak sesuai maka akan menampilan informasi bahwa input salah*/
    showPopUp();
  }
});
